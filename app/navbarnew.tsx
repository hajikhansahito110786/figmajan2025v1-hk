...
'>  
    ...
    <li className="inline-block mx-1 "><Link href="/">Shop</Link></li>
    <li className="inline-block mx-1 "><Link href="/">Produc</Link>t</li>
    <li className="inline-block mx-1 "><Link href="/">Pages</Link></li>
